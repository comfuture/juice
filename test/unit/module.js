...
test('Module loader', function() {
	...
	ok(juice.modules.indexOf('ui.Flash') > -1, 'loaded module name is stored in juice.module.loaded');
	ok(juice.scripts.indexOf('../src/ui/Flash.js') > -1, 'loaded script path is stored in juice.script.loaded');
